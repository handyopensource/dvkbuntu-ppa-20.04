...
Item {
    ...
    MouseArea {
        ...
        onEntered: { 
            ...
            switch (button.buttonType) {
                case DecorationOptions.DecorationButtonMinimize:
                    qprocess.launch('createWaveFromItem "Bouton Réduction"');
                    break;
                case DecorationOptions.DecorationButtonMaximizeRestore:
                    qprocess.launch('createWaveFromItem "Bouton Plein écran"');
                    break;
                case DecorationOptions.DecorationButtonClose:
                    qprocess.launch('createWaveFromItem "Bouton Fermeture"');
                    break;
            }
        }
        onExited: {
        ...
        onClicked: {
            ...
            case DecorationOptions.DecorationButtonMinimize:
                // minimize
                qprocess.launch('createWaveFromItem "Réduction fenêtre"');
                decoration.requestMinimize();
                break;
            case DecorationOptions.DecorationButtonMaximizeRestore:
                // maximize
                qprocess.launch('createWaveFromItem "Ouverture plein écran fenêtre"');
                decoration.requestToggleMaximization(mouse.button);
                break;
            case DecorationOptions.DecorationButtonClose:
                // close
                qprocess.launch('createWaveFromItem "Fermeture fenêtre"');
